...
const SvelteWrapper = ({ SvelteComponent, mountSvelteComponentFn, title, items, config, ...restProps }) => {
  ...
  useEffect(() => {
    ...
    if (typeof mountSvelteComponentFn !== 'function') {
      const msg = 'Svelte mount function is not available or not a function. Ensure Svelte MFE exposes "mountSvelteComponent".';
